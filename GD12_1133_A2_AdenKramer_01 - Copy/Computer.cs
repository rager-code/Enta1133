...
namespace GD12_1133_A2_AidenKramer_01
{
    internal class Computer
    {
        ...
        internal int cpuScore = 30;//cpuScore score is set to 0.
        ...
        internal int CPUDiceChooser()//Chooses the dice for the computer with random.
        {
            ...
            dicePicker = random.Next(1, 6);//Chooses between 4 different dice
        ...
        internal int CPUDice()
        {
            ...
            else if (dicePicker == 5)//If dicepicker is 1 then roll a D12.
            {
                if (rolledD25 == false)
                {
                    Console.WriteLine("           ,  /\\  .  ");
